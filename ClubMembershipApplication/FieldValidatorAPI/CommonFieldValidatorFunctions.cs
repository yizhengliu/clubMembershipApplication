...
namespace FieldValidatorAPI
{
    ...
    public delegate bool StringLengthDel(string fieldVal, int min, int max);
    ...
    public class CommonFieldValidatorFunctions
    {
        ...
        private static StringLengthDel _stringLengthValidDel = null;
        private static DateValidDel _dateValidDel = null;
        private static PatternMatchValidDel _patternValidDel = null;
        private static CompareFieldsValidDel _compareFieldsValidDel = null;

        //ensure only one instance of these delegates will be created
        //singleton pattern
        ...
        public static StringLengthDel StringLengthFieldValid
        {
            get
            {
                if (_stringLengthValidDel == null)
                    _stringLengthValidDel = new StringLengthDel(StringFieldLengthValid);
                return _stringLengthValidDel;
            }
        }

        public static DateValidDel DateFieldValid
        {
            get
            {
        ...
        public static PatternMatchValidDel PatternMatchValidDel
        {
            get
            {
                if (_patternValidDel == null)
                    _patternValidDel = new PatternMatchValidDel(FieldPatternValid);
